...
public class OpenGaussClient extends AbstractRelationalClient {
    ...
    public void init(SqlDatabaseConfig config){
        ...
        String jdbcUrl="jdbc:postgresql://"+config.host+":"+config.port+"/"+config.tags.get("schemaName").toString();
